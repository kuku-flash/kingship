    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight " style="background-image: url('images/car-bg.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="container">
          <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs"><span class="mr-2"><a href="car-listing.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Car details <i class="ion-ios-arrow-forward"></i></span></p>
       ...
       <div class="row">
            <div class="col-lg-8 bg-light">
              ...
              <div class="main">
                  <img id="mainImg" src="images/vw0.jpeg">
              </div>
  
              <div class="slide-one-item home-slider owl-carousel" >
                  
              <ul class="thumbs mt-3">
                  <li onclick="thumbChange(0)"><img class="thumb-img" src="images/vw0.jpeg"></li>
                  <li onclick="thumbChange(1)"><img class="thumb-img" src="images/vw1.jpeg" ></li>
                  <li onclick="thumbChange(2)"><img class="thumb-img" src="images/vw2.jpeg" ></li>
                  <li onclick="thumbChange(3)"><img class="thumb-img" src="images/vw3.jpeg"></li>
                  <li onclick="thumbChange(4)"><img class="thumb-img" src="images/vw4.jpeg"></li>
              </ul>
          </div>
              ...
              <div class="row ">
                  <div class="col-lg-6 text-lefts"> 
                  <p><h4>White Automatic Toyota Axio </h4></p>
                  </div>
                  <div class="col-lg-6 text-right"> 
                  <p> <h4 class="mb-0"> KSh1,170,000 </h4> <small>NEGOTIABLE</small> <span> REF-ID:q8g02w4</span> </p>
                      </div>				
                  </div>
            ...
            <div class="col-lg-4">
              ...
              <div class="mb-4 p-4 text-center bg-light">
                  <p>
                      <img src="images/flashk.jpg" alt="Avatar" class="avatar">
                  </p>
                   <p> <h3 class="h5 text-black mb-0">Flash Kuku</h3>
