        ...
        <div class="overlay"> <div class="container">
          <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
              ...
              <h1 class="mb-3 bread">Insights</h1>
              @if (session('status'))
              ...
              <div class="container">
                  ...
                  <div class="row ml-auto">
                    @include('inc.client_sidebar_nav')
                      <div class="col-md-9">
                          <div class="row">
                              <div class="col-lg-3"><div class="card  bg-success text-white text-center p-3">
                                  <blockquote class="blockquote mb-0">
                                      <big class="icon-buysellads"></big>
                                      <p class="text-white">800 <span>Total Ads</span></p>
                                    
                                    <footer class="blockquote-footer text-white">
                                      <small class="">
                                       <a href="#" class="text-white">View Detials <il class="icon-arrow-right"></il></a>
                                      </small>
                                    </footer>
                                  </blockquote>
                                </div>
                              </div>
                              <div class="col-lg-3"><div class="card  bg-warning text-white text-center p-3">
                                  <blockquote class="blockquote mb-0">
                                      <big class="icon-featured_play_list"></big>
                                      <p class="text-white">06 <span>Featured Ads</span></p>
                              ...
                              <div class="col-lg-3"><div class="card  bg-danger text-white text-center p-3">
                                  <blockquote class="blockquote mb-0">
                                      <big class="icon-airplanemode_inactive"></big>
                                      <p class="text-white">04 <span>Inactive Ads</span></p>
                              ...
                              <div class="col-lg-3"><div class="card  bg-info text-white text-center p-3">
                                  <blockquote class="blockquote mb-0">
                                      <big class="icon-message"></big>
                                      <p class="text-white">400 <span>messages</span></p>
                          ...
                          <div class="col-lg-6"> 
                              <div class="card">
                                  <div class="card-header">
                                    <h5 class="card-title">My Activity log</h5>
                    
                                    
                                  </div>
                                  <div class="card-body table-responsive">
                                      <div class="active_logs">
                                          <medium class="icon-info-circle"> you are logged in via mobile</medium>
                                      </div>
                                      <div class="active_logs">
                                          <medium class="icon-info-circle"> you are logged in via mobile</medium>
                                      </div>    
