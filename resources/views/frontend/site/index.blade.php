                ...
                <div class="text w-100 text-center mb-md-5 pb-md-5">
                  ...
                  <a href="https://vimeo.com/45830194" class="icon-wrap popup-vimeo d-flex align-items-center mt-4 justify-content-center">
                      ...
                      <div class="heading-title ml-5">
                          <span>Easy steps for either buying or selling a car and house</span>
                      </div>
                  </a>
              </div>
            </div>
                      ...
                      <div class="carousel-car owl-carousel">
                          ...
                          <div class="item">
                              <div class="car-wrap rounded ftco-animate">
                                  ...
                                  <div class="text">
                                      <h2 class="mb-0"><a href="#">Located in Karen Nandi Road</a></h2>
                                      <div class="d-flex mb-3">
                                          <span class="cat">On 1/2 Acre</span>
                      ...
                      <div class="carousel-car owl-carousel">
                          ...
                          <div class="item">
                              <div class="car-wrap rounded ftco-animate">
                                  ...
                                  <div class="text">
                                      <h2 class="mb-0"><a href="{{ url('/cars/carlist') }}">Aston Martin DB9</a></h2>
                                      <div class="d-flex mb-3">
                                          <span class="cat">Aston Martin</span>
                                          <p class="price ml-auto">Ksh 10 Million <span>Negotiable</span></p>
                                      </div>
                                      <p class="d-flex mb-0 d-block"><a href="{{ url('/cars/carlist') }}" class="btn btn-primary py-2 mr-1">Buy now</a> <a href="#" class="btn btn-secondary py-2 ml-1">Details</a></p>
                                  </div>
                              </div>
                          </div>
                          <div class="item">
